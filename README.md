...
1. Войдите в CRM.
2. Раздел **О клубе** — название, город, адрес, контакты, Telegram ID администратора.
3. Раздел **Тренеры** — карточки тренеров для бота.
4. **Игры** / **Тренировки** — расписание; при выборе клуба город и адрес подставятся из «О клубе».
5. При заявке оплаты в боте («Я оплатил») подтвердите платёж в **Оплаты**.
